...
description: >-
  Compare risk ratios and odds ratios across Brand Lift studies, derive the
  log-odds confidence interval, and pool campaign effects by inverse variance.
...
$OR$ is constant by construction. $RR$ decreases from 1.281 to 1.130 as $p_0$ increases: the ceiling compresses it. Absolute lift increases from 0.014 to 0.065. The same logit-scale effect produces different $RR$ and $p_1 - p_0$ values at different baselines.
